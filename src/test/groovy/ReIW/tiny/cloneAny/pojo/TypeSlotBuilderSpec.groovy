...
class TypeSlotBuilderSpec extends Specification {
	...
	def "createTypeSlot 型引数あり class Foo<A,B>"() {
		...
		actual.formalSlots[0].descriptor == "Ljava/lang/Object;"
		actual.formalSlots[1].typeParam == "B"
		actual.formalSlots[1].descriptor == "Ljava/lang/Object;"
		actual.superSlot.typeParam == null
		actual.superSlot.descriptor == "Ljava/lang/Object;"
	}
	...
	def "createTypeSlot 型引数あり  => class Foo<T,L extends List<T>>"() {
		...
		actual.formalSlots[1].descriptor == "Ljava/util/List;"
		and:
		actual.formalSlots[1].slotList.size()== 1
		actual.formalSlots[1].slotList[0].typeParam == "T"
		actual.formalSlots[1].slotList[0].descriptor == "Ljava/lang/Object;"
		and:
		actual.superSlot.typeParam == null
		actual.superSlot.descriptor == "Ljava/lang/Object;"
	}
	...
	def "createTypeSlot 型引数なし generic 継承 共変 => class Foo extends HashMap<Integer, ArrayList<? super String>>"() {
		...
		and:
		actual.superSlot.typeParam == null
		actual.superSlot.descriptor == "Ljava/util/HashMap;"
		actual.superSlot.slotList[0].typeParam == "="
		actual.superSlot.slotList[0].descriptor == "Ljava/lang/Integer;"
		actual.superSlot.slotList[1].typeParam == "="
		actual.superSlot.slotList[1].descriptor == "Ljava/util/ArrayList;"
		actual.superSlot.slotList[1].slotList[0].typeParam == "-"
		actual.superSlot.slotList[1].slotList[0].descriptor == "Ljava/lang/String;"
	}
	...
	def "createTypeSlot 型引数なし generic 実装 反変 => class Foo extends Set<ArrayList<? extends String>>"() {
		...
		actual.interfaceSlot[0].descriptor == "Ljava/util/Set;"
		actual.interfaceSlot[0].slotList[0].typeParam == "="
		actual.interfaceSlot[0].slotList[0].descriptor == "Ljava/util/ArrayList;"
		actual.interfaceSlot[0].slotList[0].slotList[0].typeParam == "+"
		actual.interfaceSlot[0].slotList[0].slotList[0].descriptor == "Ljava/lang/String;"
	}
	...
	def "createTypeSlot 型引数あり generic 実装 => class Foo implements List<String>, Serializable"() {
		...
		actual.interfaceSlot[0].typeParam == null
		actual.interfaceSlot[0].descriptor == "Ljava/util/List;"
		actual.interfaceSlot[0].slotList[0].typeParam == "="
		actual.interfaceSlot[0].slotList[0].descriptor == "Ljava/lang/String;"
		actual.interfaceSlot[1].typeParam == null
		actual.interfaceSlot[1].descriptor == "Ljava/io/Serializable;"
	}
	...
	def "createTypeSlot 型引数あり generic 継承 => class Foo<T> extends ArrayList<T>"() {
		...
		and:
		actual.superSlot.typeParam == null
		actual.superSlot.descriptor == "Ljava/util/ArrayList;"
		actual.superSlot.slotList[0].typeParam == "T"
		actual.superSlot.slotList[0].descriptor == "Ljava/lang/Object;"
	}
	...
	def "createTypeSlot 型引数あり generic 実装  => class Foo<T> implements List<T>"() {
		...
		actual.interfaceSlot[0].slotList[0].descriptor == "Ljava/lang/Object;"
	}
